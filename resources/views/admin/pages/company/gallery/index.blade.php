...
@push('models')
    ...
    <div class="modal fade " id="add-image">
        <div class="modal-dialog">
            <form class="modal-content ajax-form" action="{{ route('admin.company.gallery.store') }}" method="post">
                @csrf
                @method('POST')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#datatable-crud').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.company.gallery.index') }}",
                language: {
                    "decimal": "",
