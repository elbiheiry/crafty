...
@push('models')
    ...
    <div class="modal fade " id="add-faqs">
        <div class="modal-dialog">
            <form class="modal-content ajax-form" action="{{ route('admin.coupones.store') }}" method="post">
                @csrf
                @method('POST')
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label>الكوبون</label>
                            <input type="text" class="form-control required" name="coupone">
                        </div>
                        <div class="form-group col-sm-12">
                            <label>الخصم (%)</label>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#datatable-crud').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.coupones.index') }}",
                language: {
                    "decimal": "",
