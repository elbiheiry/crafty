                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">إضافه دورة جديدة</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="post" action="{{ route('admin.courses.store', ['type' => $type]) }}"
                                id="courseform">
                                @csrf
                                @method('post')
                                <div class="card-body row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group ">
                                            ...
                                            <textarea class="form-control" name="requirements" rows="7"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group ">
                                            <label>مميزات الدورة</label>
                                            <textarea class="form-control" name="advantages" rows="7"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
