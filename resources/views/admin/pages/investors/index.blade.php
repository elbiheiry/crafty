...
@push('models')
    ...
    <div class="modal fade " id="add-investors">
        <div class="modal-dialog">
            <form class="modal-content ajax-form" action="{{ route('admin.investors.store') }}" method="post">
                @csrf
                @method('POST')
                <div class="modal-header">
                    <h4 class="modal-title">إضافة مستثمر جديد</h4>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#datatable-crud').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.investors.index') }}",
                language: {
                    "decimal": "",
