...
@push('models')
    <!-- Modal Add Employees -->
    <div class="modal fade " id="add-social">
        <div class="modal-dialog">
            <form class="modal-content ajax-form" action="{{ route('admin.social.store') }}" method="post">
                @csrf
                @method('POST')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>روابط التواصل الإجتماعي</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">لوحة المراقبة</a>
                            </li>
                            <li class="breadcrumb-item active">روابط التواصل الإجتماعي</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
